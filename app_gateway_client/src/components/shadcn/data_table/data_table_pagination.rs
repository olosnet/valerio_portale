...
fn icon_chevron_left() -> leptos::prelude::AnyView { crate::components::shadcn::icon::Icon::ChevronLeft.render() }
fn icon_chevron_right() -> leptos::prelude::AnyView { crate::components::shadcn::icon::Icon::ChevronRight.render() }
